...
public class Cross_Product : Vector_Operation
{
    LA_Vector vector_1;
    LA_Vector vector_2;
    ...
    public Cross_Product(Controller controller)
    {
        ...
        Matrix4x4 mat_1 = Matrix4x4.TRS(vector_1.getTranslation(), vector_1.getRotation().rotation, vector_1.getScaling().m00 * Vector3.one);
        Matrix4x4 mat_2 = Matrix4x4.TRS(vector_2.getTranslation(), vector_2.getRotation().rotation, vector_2.getScaling().m00 * Vector3.one);
        vector_fixed = new LA_Vector(Vector3.zero, Vector3.Cross(mat_1 * vector_1.getDirection(), mat_2 * vector_2.getDirection()), Color.red);
        vector_fixed.draw();
